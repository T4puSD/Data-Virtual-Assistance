...
if __name__ == '__main__':
  ...
  FLAGS.bottleneck_dir='training/data/bottlenecks'
  FLAGS.how_many_training_steps=500
  FLAGS.model_dir='training/data/models/'
  FLAGS.summaries_dir='training/data/training_summaries/mobilenet_0.50_224'
  FLAGS.output_graph='training/data/retrained_graph.pb'
  FLAGS.output_labels='training/data/retrained_labels.txt'
  FLAGS.architecture='mobilenet_0.50_224'
  FLAGS.image_dir='train_photos'
